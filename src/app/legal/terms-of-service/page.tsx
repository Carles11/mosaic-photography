...
const TermsOfService: React.FC = () => {
  return (
    <>
      <Head>
        <title>Terms of Service - Mosaic Photography</title>
        <meta
          name="description"
          content="Read the terms of service for using Mosaic Photography's website and services."
        />
        <link
          rel="canonical"
          href="https://www.mosaic.photography/legal/terms-of-service"
        />
      </Head>
      <main className={styles.container}>
        ...
        <p className={styles.text}>
          ...
          are a photographer and see your images on this site and would like
          them to be removed, please contact me, and I will promptly remove
          them.
        </p>
        <p className={styles.text}>
          Conversely, if you are a photographer and would like to see your
          pictures featured in the mosaic, please feel free to reach out to me
          at <a href="mailto:carles@crix.design">carles@crix.design</a>.
        </p>
        <p className={styles.text}>
