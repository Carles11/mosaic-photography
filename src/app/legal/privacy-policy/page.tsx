  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        ...
        However, we may collect non-personal information such as your IP
        address, browser type, and operating system.
      </p>
      <h2 className={styles.subtitle}>Information Use</h2>
      <p className={styles.text}>
        We use the non-personal information we collect to improve our website
        and provide a better user experience.
      </p>
      <h2 className={styles.subtitle}>Information Sharing</h2>
      <p className={styles.text}>
        We do not share any personal information with third parties. However, we
        may share non-personal information with third parties for the purpose of
