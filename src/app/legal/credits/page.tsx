...
const Credits: React.FC = () => {
  return (
    <>
      <Head>
        <title>Credits - Mosaic Photography</title>
        <meta
          name="description"
          content="Credits page of Mosaic Photography, thanking the creators of logos and icons used, and providing a Ko-fi link for donations."
        />
        <meta
          name="keywords"
          content="credits, logo credits, icon credits, donations, Ko-fi, Mosaic Photography"
        />
        <link
          rel="canonical"
          href="https://www.mosaic.photography/legal/credits"
        />
      </Head>
      <main className={styles.container}>
        ...
        <p className={styles.text}>
          ...
          libraries. We would like to thank the creators of these icons for
          their work.
        </p>
        ...
        <ul className={styles.list}>
          ...
          <li>
            <a
              href="https://tholman.com/github-corners/"
